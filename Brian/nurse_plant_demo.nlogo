; Just some code I've been playing around with intended to explain null expectations and the nurse plant hypothesis to students
...
to setup
ca
ask patches [ifelse random 101 <= percent_cover [set pcolor green][set pcolor yellow]]
set-default-shape seed "circle"
set-default-shape cactus "cactus"
reset-ticks
end
